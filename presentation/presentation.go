...
import (
	...
	"github.com/chentiande/unioffice"
	"github.com/chentiande/unioffice/common"
	"github.com/chentiande/unioffice/common/license"
	"github.com/chentiande/unioffice/measurement"
	"github.com/chentiande/unioffice/schema/soo/dml"
	crt "github.com/chentiande/unioffice/schema/soo/dml/chart"
	"github.com/chentiande/unioffice/schema/soo/ofc/sharedTypes"
	"github.com/chentiande/unioffice/schema/soo/pkg/relationships"
	"github.com/chentiande/unioffice/schema/soo/pml"
	"github.com/chentiande/unioffice/zippkg"
)
...
func New() *Presentation {
	...
	p.x.SldSz.CxAttr = int32(10 * measurement.Inch)    // 宽度�?0英寸
	p.x.SldSz.CyAttr = int32(5.625 * measurement.Inch) // 高度�?.625英寸
...
func (p *Presentation) SetSlideSize(width, height measurement.Distance) {
	...
	p.x.SldSz.CxAttr = int32(width)
	p.x.SldSz.CyAttr = int32(height)
}
